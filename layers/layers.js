...
//ol.proj.get("EPSG:32721").setExtent([484040.499644, 7189777.437363, 491216.508468, 7193172.612363]);
var wms_layers = [];
...
var format_PostacinL5_3 = new ol.format.GeoJSON();
var features_PostacinL5_3 = format_PostacinL5_3.readFeatures(json_PostacinL5_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacinL5_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacinL5_3.addFeatures(features_PostacinL5_3);
var lyr_PostacinL5_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacinL5_3, 
                style: style_PostacinL5_3,
                popuplayertitle: "Postación L5",
                interactive: true,
                title: '<img src="styles/legend/PostacinL5_3.png" /> Postación L5'
            });
var format_PostacionExistenteL5_4 = new ol.format.GeoJSON();
var features_PostacionExistenteL5_4 = format_PostacionExistenteL5_4.readFeatures(json_PostacionExistenteL5_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionExistenteL5_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionExistenteL5_4.addFeatures(features_PostacionExistenteL5_4);
var lyr_PostacionExistenteL5_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionExistenteL5_4, 
                style: style_PostacionExistenteL5_4,
                popuplayertitle: "Postacion Existente L5",
                interactive: true,
                title: '<img src="styles/legend/PostacionExistenteL5_4.png" /> Postacion Existente L5'
            });
...
var group_LOTE5 = new ol.layer.Group({
                                layers: [lyr_PostacinL5_3,lyr_PostacionExistenteL5_4,],
                                fold: "open",
                                title: "LOTE 5"});
...
lyr_PostacinL5_3.set('fieldAliases', {'ALIMENT.': 'ALIMENT.', 'Sosten': 'Sosten', 'TIPO/POSTE': 'TIPO/POSTE', 'X': 'X', 'Y': 'Y', });
lyr_PostacionExistenteL5_4.set('fieldAliases', {'Nro de Sos': 'Nro de Sos', 'Coord. X': 'Coord. X', 'Coord. Y': 'Coord. Y', 'Sosten': 'Sosten', 'Poste': 'Poste', });
...
lyr_PostacinL5_3.set('fieldImages', {'ALIMENT.': 'TextEdit', 'Sosten': 'TextEdit', 'TIPO/POSTE': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', });
lyr_PostacionExistenteL5_4.set('fieldImages', {'Nro de Sos': 'TextEdit', 'Coord. X': 'TextEdit', 'Coord. Y': 'TextEdit', 'Sosten': 'TextEdit', 'Poste': 'TextEdit', });
...
lyr_PostacinL5_3.set('fieldLabels', {'ALIMENT.': 'no label', 'Sosten': 'no label', 'TIPO/POSTE': 'no label', 'X': 'no label', 'Y': 'no label', });
lyr_PostacionExistenteL5_4.set('fieldLabels', {'Nro de Sos': 'no label', 'Coord. X': 'no label', 'Coord. Y': 'no label', 'Sosten': 'no label', 'Poste': 'no label', });
