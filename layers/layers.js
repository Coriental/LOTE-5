...
//ol.proj.get("EPSG:32721").setExtent([474168.080415, 7187637.355807, 491098.124907, 7196478.999805]);
var wms_layers = [];
...
var format_PDL5_17 = new ol.format.GeoJSON();
var features_PDL5_17 = format_PDL5_17.readFeatures(json_PDL5_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDL5_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDL5_17.addFeatures(features_PDL5_17);
var lyr_PDL5_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDL5_17, 
                style: style_PDL5_17,
                popuplayertitle: 'PD L5',
                interactive: true,
                title: '<img src="styles/legend/PDL5_17.png" /> PD L5'
            });
var format_PDSistL503092025_18 = new ol.format.GeoJSON();
var features_PDSistL503092025_18 = format_PDSistL503092025_18.readFeatures(json_PDSistL503092025_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDSistL503092025_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDSistL503092025_18.addFeatures(features_PDSistL503092025_18);
var lyr_PDSistL503092025_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDSistL503092025_18, 
                style: style_PDSistL503092025_18,
                popuplayertitle: 'PD Sist L5 03-09-2025',
                interactive: true,
                title: '<img src="styles/legend/PDSistL503092025_18.png" /> PD Sist L5 03-09-2025'
            });
...
var group_Lote5 = new ol.layer.Group({
                                layers: [lyr_PDL5_17,lyr_PDSistL503092025_18,],
                                fold: 'close',
                                title: 'Lote 5'});
...
lyr_PDL5_17.set('fieldAliases', {'ALIMENTADOR': 'ALIMENTADOR', 'SOSTÉN': 'SOSTÉN', 'X': 'X', 'Y': 'Y', 'ANDE': 'ANDE', 'NRO DE FÁBRICA': 'NRO DE FÁBRICA', });
lyr_PDSistL503092025_18.set('fieldAliases', {'#': '#', 'Tipo de Poste': 'Tipo de Poste', 'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 5': 'Alimentadores Lote 5', 'Nro de Fabrica del trafo': 'Nro de Fabrica del trafo', 'N�ANDE': 'N�ANDE', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PDL5_17.set('fieldImages', {'ALIMENTADOR': 'TextEdit', 'SOSTÉN': 'TextEdit', 'X': 'Range', 'Y': 'Range', 'ANDE': 'Range', 'NRO DE FÁBRICA': 'Range', });
lyr_PDSistL503092025_18.set('fieldImages', {'#': 'Range', 'Tipo de Poste': 'TextEdit', 'Numero de Sosten': 'TextEdit', 'Alimentadores Lote 5': 'TextEdit', 'Nro de Fabrica del trafo': 'Range', 'N�ANDE': 'TextEdit', 'Longitud': 'TextEdit', 'Latitud': 'TextEdit', });
...
lyr_PDL5_17.set('fieldLabels', {'ALIMENTADOR': 'inline label - visible with data', 'SOSTÉN': 'inline label - visible with data', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'ANDE': 'inline label - visible with data', 'NRO DE FÁBRICA': 'inline label - visible with data', });
lyr_PDSistL503092025_18.set('fieldLabels', {'#': 'no label', 'Tipo de Poste': 'no label', 'Numero de Sosten': 'no label', 'Alimentadores Lote 5': 'no label', 'Nro de Fabrica del trafo': 'no label', 'N�ANDE': 'no label', 'Longitud': 'no label', 'Latitud': 'no label', });
lyr_PDSistL503092025_18.on('precompose', function(evt) {
